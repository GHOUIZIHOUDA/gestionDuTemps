...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="./assets/css/calendrier.css" rel="stylesheet" type="text/css" />
	</head>
	<?php
		...
		if(isset($_GET['admin']))
			...
			$lien_redir="../starter/date_info.php";//Lien de redirection apres un clic sur une date, NB la date selectionner va etre ajouter à ce lien afin de la récuperer ultérieurement 
		if(isset($_GET['admin']))
			...
			$clic=2;
			$col1="#FDD615";//couleur au passage du souris pour les dates normales

			$col2="#FDD615";//couleur au passage du souris pour les dates speciaux

			$col3="#FDD615";//couleur au passage du souris pour les dates férié
	...
	<body>
		<center  style="background-color:#000000">
			<div id="lien" style="margin-top:120px;">
				<?php
					if(isset($_GET['admin']))
						echo '<a href="agenda.php">Passer en mode Admin</a>';
					else
						echo'<a href="?admin">Passer en mode User</a>';
				?>
			</div>
			<form name="dt" method="get" action="">
				...
				?>
				<select name="mois" id="mois" onChange="change()" class="liste" style="background-color:#FFFFFF; color:#000000">
					<?php
						for($i=1;$i<13;$i++)
						{
							echo '<option value="'.$i.'"';
				...
				<select name="annee" id="annee" onChange="change()" class="liste" class="liste" style="background-color:#FFFFFF; color:#000000">
					<?php
						for($i=2021;$i<2065;$i++)
						{
							echo '<option value="'.$i.'"';
			...
			<table class="tableau " style="margin-bottom:100px; background-color:#ffffff"><caption><?php echo $titre ;?></caption>
